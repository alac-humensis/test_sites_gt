...
import BasicColors from './basic_accessor.mjs';
import {FilterSideBar, Filter} from './filter.mjs';

class GtSiteStructure{
  constructor(site) {
    let self = this;
    this.site = site;

    let activeColor = misc.colorFromHex('#E60077');
    let activeFilterColor = misc.colorFromHex('#0298ca');
    let inactiveColor = misc.colorFromHex('#6C797A');
    let lightText = misc.colorFromHex('#FFF');
    ...
    this.common = {
      ...
      }*/
      {
        ...
        lightText : lightText,
        filters : {
          activeColor : misc.colorFromHex('#0298ca'),
...
export default GtSiteStructure;